...
#include "../../untitled12/taskwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TaskWindow_t, stringdata) + ofs \
...
const QMetaObject TaskWindow::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_TaskWindow.data,
      qt_meta_data_TaskWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TaskWindow.stringdata))
